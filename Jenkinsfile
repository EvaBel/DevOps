    ...
    stages {
        ...
        stage('Run Tests') {
         ...
         stage(' Build DockerImage') {
            steps {
                ...
                sh 'docker build -t eva057/DevOps:latest -f DockerFile .'
            }
        }
        ...
        script {
            withCredentials([usernamePassword(credentialsId: 'docker-hub-credentials', usernameVariable: 'DOCKER_USERNAME', passwordVariable: 'DOCKER_PASSWORD')]) {
                ...
                sh 'docker push eva057/DevOps:latest'
            }
        }
    }
         ...
         stage('Deploy to Kubernetes') {
            steps {
                script {
                    ...
                    sh 'kubectl rollout status deployment/devopscontainer -n devops'
                }
            }
        }
